...
pub fn view(model: &Model) -> Node<Msg> {
    section![
        h1![C!["title", "ml-6", "mt-6", "mb-5"], "Time Tracker",],
        div![
...
fn view_client(client_id: ClientId, client: &Client) -> Node<Msg> {
    div![
        ...
        div![
            C!["level", "is-mobile"],
            div![C!["is-size-3", "has-text-link-light"], &client.name,],
        ],
        client
            .projects
            .iter()
...
fn view_start_stop_button(client_id: ClientId, project_id: ProjectId, started: bool) -> Node<Msg> {
    div![
        ...
        button![
            C![
                "button",
                if started { "is-warning" } else { "is-primary" },
                "is-rounded"
            ],
...
fn view_time_entry(
    ...
    div![
        C![
            ...
            IF!(not(active) => "has-text-link-light")
        ],
        div![
            C!["level", "is-mobile"],
            style! {St::MarginBottom => px(5)},
            input![
                C![
                    "input",
                    "is-size-4",
                ...
                input_ev(Ev::Input, move |name| Msg::TimeEntryNameChanged(
                    client_id,
                    project_id,
                    time_entry_id,
                    name
                )),
                ev(Ev::Change, move |_| Msg::SaveTimeEntryName(
                    client_id,
                    project_id,
                    time_entry_id
                )),
            ...
            view_delete_button(
                move || Msg::DeleteTimeEntry(client_id, project_id, time_entry_id),
                active
            ),
        ],
        div![
            C!["level", "is-mobile", "is-hidden-tablet"],
...
fn view_started(
    ...
    div![
        ...
        input![
            ...
            input_ev(Ev::Input, move |date| Msg::TimeEntryStartedDateChanged(
                client_id,
                project_id,
                time_entry_id,
                date
            )),
            ev(Ev::Change, move |_| Msg::SaveTimeEntryChange(
                client_id,
                project_id,
                time_entry_id
            )),
        ...
        input![
            ...
            input_ev(Ev::Input, move |time| Msg::TimeEntryStartedTimeChanged(
                client_id,
                project_id,
                time_entry_id,
                time
...
fn view_stopped(
    ...
    div![
        ...
        input![
            ...
            input_ev(Ev::Input, move |date| Msg::TimeEntryStoppedDateChanged(
                client_id,
                project_id,
                time_entry_id,
                date
        ...
        input![
            ...
            input_ev(Ev::Input, move |time| Msg::TimeEntryStoppedTimeChanged(
                client_id,
                project_id,
                time_entry_id,
                time
...
fn view_duration(
    ...
    input![
        ...
        input_ev(Ev::Input, move |duration| Msg::TimeEntryDurationChanged(
            client_id,
            project_id,
            time_entry_id,
            duration
